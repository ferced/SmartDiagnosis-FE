...
const FILES = [
  'Advances-in-Cardiovascular-Disease-Research-2024.pdf',
  'Molecular-Genetics-in-Cancer-Diagnosis.pdf',
  'Neurodegenerative-Diseases-Emerging-Therapies.pdf',
  'Pediatric-Infectious-Diseases-Update.pdf',
  'Epidemiology-of-Chronic-Respiratory-Diseases.pdf',
  'Clinical-Trials-in-Autoimmune-Disorders.pdf',
  'Pathogenesis-of-Viral-Infections.pdf',
  'Advancements-in-HIV-AIDS-Research.pdf',
  'Innovations-in-Diabetic-Retinopathy-Treatment.pdf',
  'Mental-Health-Disorders-and-Cognitive-Therapy.pdf',
  'Antimicrobial-Resistance-Patterns.pdf',
  'Vaccine-Development-for-Emerging-Infectious-Diseases.pdf',
  'Managing-Chronic-Kidney-Disease.pdf',
  'Surgical-Techniques-in-Organ-Transplantation.pdf',
  'Therapeutic-Approaches-to-Rheumatoid-Arthritis.pdf',
  'Genomic-Medicine-in-Cancer-Treatment.pdf',
  'Public-Health-Policies-for-Non-Communicable-Diseases.pdf',
  'Nutrition-and-Dietetics-in-Chronic-Disease-Management.pdf',
  'Pediatric-Neurology-Breakthroughs.pdf',
  'Geriatric-Medicine-Challenges-and-Solutions.pdf',
  'Ophthalmology-Innovations-and-Case-Studies.pdf',
  'Orthopedic-Disorders-and-Rehabilitation.pdf',
  'Cardiac-Surgery-Advances-and-Patient-Care.pdf',
  'Infectious-Disease-Epidemiology-and-Control.pdf',
];
